...
class API { 
    ...
    async photoRoom1cache(idUser, email, imageroom1) {
        let localUri = imageroom1;
          ...
          return await fetch(`YOURENDPOINT/editRoomapp.php?email=${eMail}&id=${id}&photo1=${photo1}`, {
            method: 'POST',
            body: formData,
            header: {
    ...
    async photoRoom1_2cache(idUser, email, imageroom1_2) {
        let localUri1_2 = imageroom1_2;
          ...
          return await fetch(`YOURENDPOINT/editRoomapp.php?email=${eMail}&id=${id}&photo1_2=${photo1_2}`, {
            method: 'POST',
            body: formData,
            header: {
                'Content-Type': 'multipart/form-data'
    ...
    async photoRoom1_3cache(idUser, email, imageroom1_3) {
        let localUri1_3 = imageroom1_3;
          ...
          return await fetch(`YOURENDPOINT/editRoomapp.php?email=${eMail}&id=${id}&photo1_3=${photo1_3}`, {
            method: 'POST',
            body: formData,
            header: {
                'Content-Type': 'multipart/form-data'
    ...
    async photoRoom2cache(idUser, email, imageroom2) {
        let localUri2 = imageroom2;
          ...
          return await fetch(`YOURENDPOINT/editRoomapp.php?email=${eMail}&id=${id}&photo2=${photo2}`, {
            method: 'POST',
            body: formData,
            header: {
                'Content-Type': 'multipart/form-data'
    ...
    async photoRoom2_2cache(idUser, email, imageroom2_2) {
        let localUri2_2 = imageroom2_2;
          ...
          return await fetch(`YOURENDPOINT/editRoomapp.php?email=${eMail}&id=${id}&photo2_2=${photo2_2}`, {
            method: 'POST',
            body: formData,
            header: {
                'Content-Type': 'multipart/form-data'
    ...
    async photoRoom2_3cache(idUser, email, imageroom2_3) {
        let localUri2_3 = imageroom2_3;
          ...
          return await fetch(`YOURENDPOINT/editRoomapp.php?email=${eMail}&id=${id}&photo2_3=${photo2_3}`, {
            method: 'POST',
            body: formData,
            header: {
                'Content-Type': 'multipart/form-data'
    ...
    async photoRoom3cache(idUser, email, imageroom3) {
        let localUri3 = imageroom3;
          ...
          return await fetch(`YOURENDPOINT/editRoomapp.php?email=${eMail}&id=${id}&photo3=${photo3}`, {
            method: 'POST',
            body: formData,
            header: {
                'Content-Type': 'multipart/form-data'
    ...
    async photoRoom3_2cache(idUser, email, imageroom3_2) {
        let localUri3_2 = imageroom3_2;
          ...
          return await fetch(`YOURENDPOINT/editRoomapp.php?email=${eMail}&id=${id}&photo3_2=${photo3_2}`, {
            method: 'POST',
            body: formData,
            header: {
                'Content-Type': 'multipart/form-data'
    ...
    async photoRoom3_3cache(idUser, email, imageroom3_3) {
        let localUri3_3 = imageroom3_3;
          ...
          return await fetch(`YOURENDPOINT/editRoomapp.php?email=${eMail}&id=${id}&photo3_3=${photo3_3}`, {
            method: 'POST',
            body: formData,
            header: {
                'Content-Type': 'multipart/form-data'
    ...
    async photoRoom4cache(idUser, email, imageroom4) {
        let localUri4 = imageroom4;
          ...
          return await fetch(`YOURENDPOINT/editRoomapp.php?email=${eMail}&id=${id}&photo4=${photo4}`, {
            method: 'POST',
            body: formData,
            header: {
                'Content-Type': 'multipart/form-data'
    ...
    async photoRoom4_2cache(idUser, email, imageroom4_2) {
        let localUri4_2 = imageroom4_2;
          ...
          return await fetch(`YOURENDPOINT/editRoomapp.php?email=${eMail}&id=${id}&photo4_2=${photo4_2}`, {
            method: 'POST',
            body: formData,
            header: {
                'Content-Type': 'multipart/form-data'
    ...
    async photoRoom4_3cache(idUser, email, imageroom4_3) {
        let localUri4_3 = imageroom4_3;
          ...
          return await fetch(`YOURENDPOINT/editRoomapp.php?email=${eMail}&id=${id}&photo4_3=${photo4_3}`, {
            method: 'POST',
            body: formData,
            header: {
                'Content-Type': 'multipart/form-data'
    ...
    async photoRoom5cache(idUser, email, imageroom5) {
        let localUri5 = imageroom5;
          ...
          return await fetch(`YOURENDPOINT/editRoomapp.php?email=${eMail}&id=${id}&photo5=${photo5}`, {
            method: 'POST',
            body: formData,
            header: {
                'Content-Type': 'multipart/form-data'
    ...
    async photoRoom5_2cache(idUser, email, imageroom5_2) {
        let localUri5_2 = imageroom5_2;
          ...
          return await fetch(`YOURENDPOINT/editRoomapp.php?email=${eMail}&id=${id}&photo5_2=${photo5_2}`, {
            method: 'POST',
            body: formData,
            header: {
                'Content-Type': 'multipart/form-data'
    ...
    async photoRoom5_3cache(idUser, email, imageroom5_3) {
        let localUri5_3 = imageroom5_3;
          ...
          return await fetch(`YOURENDPOINT/editRoomapp.php?email=${eMail}&id=${id}&photo5_3=${photo5_3}`, {
            method: 'POST',
            body: formData,
            header: {
                'Content-Type': 'multipart/form-data'
    ...
    async photoRoom6cache(idUser, email, imageroom6) {
        let localUri6 = imageroom6;
          ...
          return await fetch(`YOURENDPOINT/editRoomapp.php?email=${eMail}&id=${id}&photo6=${photo6}`, {
            method: 'POST',
            body: formData,
            header: {
                'Content-Type': 'multipart/form-data'
    ...
    async photoRoom6_2cache(idUser, email, imageroom6_2) {
        let localUri6_2 = imageroom6_2;
          ...
          return await fetch(`YOURENDPOINT/editRoomapp.php?email=${eMail}&id=${id}&photo6_2=${photo6_2}`, {
            method: 'POST',
            body: formData,
            header: {
                'Content-Type': 'multipart/form-data'
    ...
    async photoRoom6_3cache(idUser, email, imageroom6_3) {
        let localUri6_3 = imageroom6_3;
          ...
          return await fetch(`YOURENDPOINT/editRoomapp.php?email=${eMail}&id=${id}&photo6_3=${photo6_3}`, {
            method: 'POST',
            body: formData,
            header: {
                'Content-Type': 'multipart/form-data'
    ...
    async photoRoom7cache(idUser, email, imageroom7) {
        let localUri7 = imageroom7;
          ...
          return await fetch(`YOURENDPOINT/editRoomapp.php?email=${eMail}&id=${id}&photo7=${photo7}`, {
            method: 'POST',
            body: formData,
            header: {
                'Content-Type': 'multipart/form-data'
    ...
    async photoRoom7_2cache(idUser, email, imageroom7_2) {
        let localUri7_2 = imageroom7_2;
          ...
          return await fetch(`YOURENDPOINT/editRoomapp.php?email=${eMail}&id=${id}&photo7_2=${photo7_2}`, {
            method: 'POST',
            body: formData,
            header: {
                'Content-Type': 'multipart/form-data'
    ...
    async photoRoom7_3cache(idUser, email, imageroom7_3) {
        let localUri7_3 = imageroom7_3;
          ...
          return await fetch(`YOURENDPOINT/editRoomapp.php?email=${eMail}&id=${id}&photo7_3=${photo7_3}`, {
            method: 'POST',
            body: formData,
            header: {
                'Content-Type': 'multipart/form-data'
    ...
    async photoRoom8cache(idUser, email, imageroom8) {
        let localUri8 = imageroom8;
          ...
          return await fetch(`YOURENDPOINT/editRoomapp.php?email=${eMail}&id=${id}&photo8=${photo8}`, {
            method: 'POST',
            body: formData,
            header: {
                'Content-Type': 'multipart/form-data'
    ...
    async photoRoom8_2cache(idUser, email, imageroom8_2) {
        let localUri8_2 = imageroom8_2;
          ...
          return await fetch(`YOURENDPOINT/editRoomapp.php?email=${eMail}&id=${id}&photo8_2=${photo8_2}`, {
            method: 'POST',
            body: formData,
            header: {
                'Content-Type': 'multipart/form-data'
    ...
    async photoRoom8_3cache(idUser, email, imageroom8_3) {
        let localUri8_3 = imageroom8_3;
          ...
          return await fetch(`YOURENDPOINT/editRoomapp.php?email=${eMail}&id=${id}&photo8_3=${photo8_3}`, {
            method: 'POST',
            body: formData,
            header: {
                'Content-Type': 'multipart/form-data'
