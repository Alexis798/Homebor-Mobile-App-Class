    ...
    ImagesCache = async () => {
        ...
        if (this.state.idnoti2 == 1) {
            if(this.state.info[0].data.proom1 != 'NULL') {
                const proom1 = `YOURENDPOINT/${this.state.info[0].data.proom1}`;
            ...
            if(this.state.info[0].data.proom1_2 != 'NULL') {
                const proom1_2 = `YOURENDPOINT/${this.state.info[0].data.proom1_2}`;
            ...
            if(this.state.info[0].data.proom1_3 != 'NULL') {
                const proom1_3 = `YOURENDPOINT/${this.state.info[0].data.proom1_3}`;
            ...
            if(this.state.room1 != undefined) {
                this.state.room1.map(async (item) => {
                    ...
                    if(item.photo != "NULL") {
                        const photoStudent = `YOURENDPOINT/${item.photo_s}`;
        ...
        if (this.state.idnoti2 == 2) {
            if(this.state.info[0].data.proom2 != 'NULL') {
                const proom2 = `YOURENDPOINT/${this.state.info[0].data.proom2}`;
            ...
            if(this.state.info[0].data.proom2_2 != 'NULL') {
                const proom2_2 = `YOURENDPOINT/${this.state.info[0].data.proom2_2}`;
            ...
            if(this.state.info[0].data.proom2_3 != 'NULL') {
                const proom2_3 = `YOURENDPOINT/${this.state.info[0].data.proom2_3}`;
        ...
        if (this.state.idnoti2 == 3) {
            if(this.state.info[0].data.proom3 != 'NULL') {
                const proom3 = `YOURENDPOINT/${this.state.info[0].data.proom3}`;
            ...
            if(this.state.info[0].data.proom3_2 != 'NULL') {
                const proom3_2 = `YOURENDPOINT/${this.state.info[0].data.proom3_2}`;
            ...
            if(this.state.info[0].data.proom3_3 != 'NULL') {
                const proom3_3 = `YOURENDPOINT/${this.state.info[0].data.proom3_3}`;
        ...
        if (this.state.idnoti2 == 4) {
            if(this.state.info[0].data.proom4 != 'NULL') {
                const proom4 = `YOURENDPOINT/${this.state.info[0].data.proom4}`;
            ...
            if(this.state.info[0].data.proom4_2 != 'NULL') {
                const proom4_2 = `YOURENDPOINT/${this.state.info[0].data.proom4_2}`;
            ...
            if(this.state.info[0].data.proom4_3 != 'NULL') {
                const proom4_3 = `YOURENDPOINT/${this.state.info[0].data.proom4_3}`;
        ...
        if (this.state.idnoti2 == 5) {
            if(this.state.info[0].data.proom5 != 'NULL') {
                const proom5 = `YOURENDPOINT/${this.state.info[0].data.proom5}`;
            ...
            if(this.state.info[0].data.proom5_2 != 'NULL') {
                const proom5_2 = `YOURENDPOINT/${this.state.info[0].data.proom5_2}`;
            ...
            if(this.state.info[0].data.proom5_3 != 'NULL') {
                const proom5_3 = `YOURENDPOINT/${this.state.info[0].data.proom5_3}`;
        ...
        if (this.state.idnoti2 == 6) {
            if(this.state.info[0].data.proom6 != 'NULL') {
                const proom6 = `YOURENDPOINT/${this.state.info[0].data.proom6}`;
            ...
            if(this.state.info[0].data.proom6_2 != 'NULL') {
                const proom6_2 = `YOURENDPOINT/${this.state.info[0].data.proom6_2}`;
            ...
            if(this.state.info[0].data.proom6_3 != 'NULL') {
                const proom6_3 = `YOURENDPOINT/${this.state.info[0].data.proom6_3}`;
        ...
        if (this.state.idnoti2 == 7) {
            if(this.state.info[0].data.proom7 != 'NULL') {
                const proom7 = `YOURENDPOINT/${this.state.info[0].data.proom7}`;
            ...
            if(this.state.info[0].data.proom7_2 != 'NULL') {
                const proom7_2 = `YOURENDPOINT/${this.state.info[0].data.proom7_2}`;
            ...
            if(this.state.info[0].data.proom7_3 != 'NULL') {
                const proom7_3 = `YOURENDPOINT/${this.state.info[0].data.proom7_3}`;
        ...
        if (this.state.idnoti2 == 8) {
            if(this.state.info[0].data.proom8 != 'NULL') {
                const proom8 = `YOURENDPOINT/${this.state.info[0].data.proom8}`;
            ...
            if(this.state.info[0].data.proom8_2 != 'NULL') {
                const proom8_2 = `YOURENDPOINT/${this.state.info[0].data.proom8_2}`;
            ...
            if(this.state.info[0].data.proom8_3 != 'NULL') {
                const proom8_3 = `YOURENDPOINT/${this.state.info[0].data.proom8_3}`;
