  ...
  constructor(props){ 
    ...
    registerfile1 = async () => {
        ...
        if (localUri == null) { this.registerfile2() } 
          ...
          return await fetch(`YOURNEDPOINT?email=${eMail}&id=${id}&photo1=${photo1}`, {
            method: 'POST',
            body: formData,
            header: {
    ...
    registerfile2 = async () => {
        ...
        if (localUri2 == null) { this.registerfile3() } 
          ...
          return await fetch(`YOURNEDPOINT?email=${eMail}&id=${id}&photo2=${photo2}`, {
            method: 'POST',
            body: formData,
            header: {
                'Content-Type': 'multipart/form-data'
    ...
    registerfile3 = async () => {
        ...
        if (localUri3 == null) { this.registerfile4() } 
          ...
          return await fetch(`YOURNEDPOINT?email=${eMail}&id=${id}&photo3=${photo3}`, {
            method: 'POST',
            body: formData,
            header: {
                'Content-Type': 'multipart/form-data'
    ...
    registerfile4 = async () => {
        ...
        if (localUri4 == null) { this.registerfile5() } 
          ...
          return await fetch(`YOURNEDPOINT?email=${eMail}&id=${id}&photo4=${photo4}`, {
            method: 'POST',
            body: formData,
            header: {
                'Content-Type': 'multipart/form-data'
    ...
    registerfile5 = async () => {
        ...
        if (localUri5 == null) { this.registerfile6() } 
          ...
          return await fetch(`YOURNEDPOINT?email=${eMail}&id=${id}&photo5=${photo5}`, {
            method: 'POST',
            body: formData,
            header: {
                'Content-Type': 'multipart/form-data'
    ...
    registerfile6 = async () => {
        ...
        if (localUri6 == null) { this.registerfile7() } 
          ...
          return await fetch(`YOURNEDPOINT?email=${eMail}&id=${id}&photo6=${photo6}`, {
            method: 'POST',
            body: formData,
            header: {
                'Content-Type': 'multipart/form-data'
    ...
    registerfile7 = async () => {
        ...
        if (localUri7 == null) { this.registerfile8() } 
          ...
          return await fetch(`YOURNEDPOINT?email=${eMail}&id=${id}&photo7=${photo7}`, {
            method: 'POST',
            body: formData,
            header: {
                'Content-Type': 'multipart/form-data'
    ...
    registerfile8 = async () => {
        ...
        if (localUri8 == null) { this.registerfile9() } 
          ...
          return await fetch(`YOURNEDPOINT?email=${eMail}&id=${id}&photo8=${photo8}`, {
            method: 'POST',
            body: formData,
            header: {
                'Content-Type': 'multipart/form-data'
    ...
    registerfile9 = async () => {
        ...
        if (localUri9 == null) { this.registerfile10() } 
          ...
          return await fetch(`YOURNEDPOINT?email=${eMail}&id=${id}&photo9=${photo9}`, {
            method: 'POST',
            body: formData,
            header: {
                'Content-Type': 'multipart/form-data'
    ...
    registerfile10 = async () => {
        ...
        if (localUri10 == null) { this.registerfile11() } 
          ...
          return await fetch(`YOURNEDPOINT?email=${eMail}&id=${id}&photo10=${photo10}`, {
            method: 'POST',
            body: formData,
            header: {
                'Content-Type': 'multipart/form-data'
    ...
    registerfile11 = async () => {
        ...
        if (localUri11 == null) { } 
          ...
          return await fetch(`YOURNEDPOINT?email=${eMail}&id=${id}&photo11=${photo11}`, {
            method: 'POST',
            body: formData,
            header: {
                'Content-Type': 'multipart/form-data'
    ...
    registerlog = async () => {
          ...
          return await fetch(`YOURNEDPOINT?email=${eMail}&id=${id}&photo0=${photo0}&idm=${idm}`, {
            method: 'POST',
            header: {
                'Content-Type': 'multipart/form-data'
            },
                    ...
                    <TouchableOpacity onPress={()=>this._Alerthome()}>
                                <Card style={globalStyles.shadowbox}>
                                    ...
                                    <Divider bg="gray.800"/>
                                            ...
                                            :
                                            <Image source={{uri: `YOURENDPOINT/${item.phome}`}}
                                            style={globalStyles.ImageGalleryedit} />
                                            :
                            ...
                            <Card style={globalStyles.shadowbox}>
                              ...
                              <Divider bg="gray.800"/>
                                            ...
                                            style={globalStyles.ImageGalleryedit} />
                                            :
                                            <Image source={{uri: `YOURENDPOINT/${item.pliving}`}}
                                            style={globalStyles.ImageGalleryedit} />
                                            :
                            ...
                            <TouchableOpacity onPress={()=>this._Alertfamily()}>
                                <Card style={globalStyles.shadowbox}>
                                  ...
                                  <Divider bg="gray.800"/>
                                            ...
                                            style={globalStyles.ImageGalleryedit} />
                                            :
                                            <Image source={{uri: `YOURENDPOINT/${item.fp}`}}
                                            style={globalStyles.ImageGalleryedit} />
                                            :
                        ...
                        <ScrollView horizontal={true}>
                            ...
                            <Card style={globalStyles.shadowbox}>
                                ...
                                <Divider bg="gray.800"/>
                                            ...
                                            style={globalStyles.ImageGalleryedit} />
                                            :
                                            <Image source={{uri: `YOURENDPOINT/${item.parea1}`}}
                                            style={globalStyles.ImageGalleryedit} />
                                            :
                            ...
                            <TouchableOpacity onPress={()=>this._Alertdining()}>
                                <Card style={globalStyles.shadowbox}>
                                    ...
                                    <Divider bg="gray.800"/>
                                            ...
                                            style={globalStyles.ImageGalleryedit} />
                                            :
                                            <Image source={{uri: `YOURENDPOINT/${item.parea2}`}}
                                            style={globalStyles.ImageGalleryedit} />
                                            :
                            ...
                            <Card style={globalStyles.shadowbox}>
                                ...
                                <Divider bg="gray.800"/>
                                            ...
                                            style={globalStyles.ImageGalleryedit} />
                                            :
                                            <Image source={{uri: `YOURENDPOINT/${item.parea3}`}}
                                            style={globalStyles.ImageGalleryedit} />
                                            :
                            ...
                            <TouchableOpacity onPress={()=>this._Alertcommon2()}>
                                <Card style={globalStyles.shadowbox}>
                                    ...
                                    <Divider bg="gray.800"/>
                                            ...
                                            style={globalStyles.ImageGalleryedit} />
                                            :
                                            <Image source={{uri: `YOURENDPOINT/${item.parea4}`}}
                                            style={globalStyles.ImageGalleryedit} />
                                            :
                        ...
                        <ScrollView horizontal={true}>
                            ...
                            <Card style={globalStyles.shadowbox}>
                                ...
                                <Divider bg="gray.800"/>
                                            ...
                                            style={globalStyles.ImageGalleryedit} />
                                            :
                                            <Image source={{uri: `YOURENDPOINT/${item.pbath1}`}}
                                            style={globalStyles.ImageGalleryedit} />
                                            :
                            ...
                            <TouchableOpacity onPress={()=>this._Alertbath2()}>
                                <Card style={globalStyles.shadowbox}>
                                    ...
                                    <Divider bg="gray.800"/>
                                            ...
                                            style={globalStyles.ImageGalleryedit} />
                                            :
                                            <Image source={{uri: `YOURENDPOINT/${item.pbath2}`}}
                                            style={globalStyles.ImageGalleryedit} />
                                            :
                            ...
                            <Card style={globalStyles.shadowbox}>
                                ...
                                <Divider bg="gray.800"/>
                                            ...
                                            style={globalStyles.ImageGalleryedit} />
                                            :
                                            <Image source={{uri: `YOURENDPOINT/${item.pbath3}`}}
                                            style={globalStyles.ImageGalleryedit} />
                                            :
                            ...
                            <TouchableOpacity onPress={()=>this._Alertbath4()}>
                                <Card style={globalStyles.shadowbox}>
                                    ...
                                    <Divider bg="gray.800"/>
                                            ...
                                            style={globalStyles.ImageGalleryedit} />
                                            :
                                            <Image source={{uri: `YOURENDPOINT/${item.pbath4}`}}
                                            style={globalStyles.ImageGalleryedit} />
                                            :
