  ...
  constructor(props){ 
    ...
    registerfilep = async () => {
      ...
      if (localUrip == null) { this.registerfile1() } 
        ...
        return await fetch(`YOURENDPOINT/?id=${id}&email=${email}&law=${law}`, {
          method: 'POST',
          body: formData,
          header: {
    ...
    registerfile1 = async () => {
        ...
        if (localUri == null) { this.registerfile2() } 
          ...
          return await fetch(`YOURENDPOINT/?id=${id}&email=${email}&lawf1=${lawf1}`, {
            method: 'POST',
            body: formData,
            header: {
              Accept: "application/json",
    ...
    registerfile2 = async () => {
        ...
        if (localUri2 == null) { this.registerfile3() }
          ...
          return await fetch(`YOURENDPOINT/?id=${id}&email=${email}&lawf2=${lawf2}`, {
            method: 'POST',
            body: formData,
            header: {
              Accept: "application/json",
    ...
    registerfile3 = async () => {
        ...
        if (localUri3 == null) { this.registerfile4() }
          ...
          return await fetch(`YOURENDPOINT/?id=${id}&email=${email}&lawf3=${lawf3}`, {
            method: 'POST',
            body: formData,
            header: {
              Accept: "application/json",
    ...
    registerfile4 = async () => {
        ...
        if (localUri4 == null) { this.registerfile5() }
          ...
          return await fetch(`YOURENDPOINT/?id=${id}&email=${email}&lawf4=${lawf4}`, {
            method: 'POST',
            body: formData,
            header: {
              Accept: "application/json",
    ...
    registerfile5 = async () => {
        ...
        if (localUri5 == null) { this.registerfile6() }
          ...
          return await fetch(`YOURENDPOINT/?id=${id}&email=${email}&lawf5=${lawf5}`, {
            method: 'POST',
            body: formData,
            header: {
              Accept: "application/json",
    ...
    registerfile6 = async () => {
        ...
        if (localUri6 == null) { this.registerfile7() }
          ...
          return await fetch(`YOURENDPOINT/?id=${id}&email=${email}&lawf6=${lawf6}`, {
            method: 'POST',
            body: formData,
            header: {
              Accept: "application/json",
    ...
    registerfile7 = async () => {
        ...
        if (localUri7 == null) { this.registerfile8() }
          ...
          return await fetch(`YOURENDPOINT/?id=${id}&email=${email}&lawf7=${lawf7}`, {
            method: 'POST',
            body: formData,
            header: {
              Accept: "application/json",
    ...
    registerfile8 = async () => {
        ...
        if (localUri8 == null) { 
          ...
          return await fetch(`YOURENDPOINT/?id=${id}&email=${email}&lawf8=${lawf8}`, {
            method: 'POST',
            body: formData,
            header: {
              Accept: "application/json",
