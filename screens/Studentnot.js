										...
										<View>
														...
														{item.photo_a != 'NULL' && (
															<AspectRatio w="100%" ratio={16 / 9}>
																<View style={globalStyles.ProfileBannerView}>
																	...
																	source={{ uri: `YOURENDPOINT/${item.photo_a}` }}
																	resizeMode="stretch"
																	/>
																</View>
															</AspectRatio>
											...
											<View style={ globalStyles.profileMargins}>
												<HStack mt="2%" space={5} width="100%">
													<VStack width="45%">
														<Avatar size="lg" bg="#232159" style={globalStyles.profileStudentnot} source={ item.photo_s != "NULL" && { uri: `YOURENDPOINT/${item.photo_s}` }}>{item.photo_s.toUpperCase().charAt(0)}</Avatar>
													</VStack>
