...
export default class Vouchers extends Component {
  ...
  ImagesCache = () => {
    this.state.vouchers != undefined && this.state.vouchers.map(async (item) => {
          ...
          const photoVoucher = `YOURENDPOINT/${item.photo}`;
                                      ...
                                      <Card>
                                        ...
                                        <Center>
                                          <View style={globalStyles.inlineDataVoucherButton}>
                                            <Button style={globalStyles.ButtonViewVoucher} onPress={this.state.connection_status ? () => Linking.openURL(`YOURENDPOINT`) : () => this.noInternetConnection() }><Icon as={Ionicons} name="eye" size="5" style={globalStyles.VoucherviewIcons}> View</Icon></Button>
                                          </View>
                                        </Center>
                                      </Card>
                                    </View>
